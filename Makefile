...
sources		= adder.v aludec.v alu.v contr.v cpu.v data_mem_tb.v datapath.v instr_mem.v maindec.v shifter.v mux3to1.v mux2to1.v PC.v pc_val_mux.v ram.v reg_file.v sign_ext.v  

sim_sources	=  cpu_tb.v adder.v aludec.v alu.v contr.v cpu.v data_mem_tb.v datapath.v instr_mem.v maindec.v shifter.v mux3to1.v mux2to1.v PC.v pc_val_mux.v ram.v reg_file.v sign_ext.v  
